...
if __name__ == '__main__':
    ...
    parser.add_argument('--paraphrasedata_path', type=str, default='')
    ...
    save_path=os.path.join('./poisoned_models/',bert_selected,data_selected,'poison_bert.pkl')
    ...
    poison_data_path = os.path.join('./experiment_data/poison' + data_selected, str(poison_rate))
    if os.path.exists(poison_data_path):
        ...
        train_data_poison, dev_data_poison, test_data_poison = get_all_data(args.paraphrasedata_path)
