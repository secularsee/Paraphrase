...
def test_PPL(all_PPL,data):
    ...
    for i, PPL_li in enumerate(all_PPL):
        ...
        #print(i)
        if whole_sentence_PPL<1000:
            processed_PPL+=whole_sentence_PPL
            k+=1
...
if __name__ == '__main__':
    ...
    model_path=os.path.join('./poisoned_models/',bert_selected,data_selected,'poison_bert.pkl')
    ...
    ave_PPL=test_PPL(all_PPL,orig_poison_data)
    print('ave_PPL:',ave_PPL)
